...
<!--    <a href="https://tryquiet.org"><strong>tryquiet.org »</strong></a> -->
    <a href="https://github.com/TryQuiet/quiet/releases/tag/quiet%401.1.1"><strong>Downloads</strong></a> | 
...
To try Quiet, download the [latest release](https://github.com/TryQuiet/quiet/releases/tag/quiet%401.1.1) for your platform (.dmg for macOS, .exe for Windows, etc.) and install it in the normal way. Then create a community and open the community's settings to invite members. 

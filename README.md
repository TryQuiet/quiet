...
The Quiet desktop app for Mac, Windows, and Linux is stable and should be fairly easy to get running locally and contribute to. It is an Electron app with a Node.js backend, bundled with Tor binaries for each platform. For how to build it, see the [Desktop README](https://github.com/TryQuiet/monorepo/tree/master/packages/desktop#readme).

The Quiet Android app is still a proof of concept, will be difficult to build, and may not work as expected. For how to build it, see the [Mobile README]()

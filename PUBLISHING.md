...
- [ ] Update desktop Tor binaries for the next release: `./scripts/update-tor-binaries-desktop.sh`
- [ ] Update mobile binaries (TODO: build a streamlined workflow for this)

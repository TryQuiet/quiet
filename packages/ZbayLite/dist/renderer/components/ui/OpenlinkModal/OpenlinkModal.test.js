...
const OpenlinkModal_1 = require("./OpenlinkModal");
describe('OpenlinkModal', () => {
    it('renders component', () => {
        const result = (0, renderComponent_1.renderComponent)(react_1.default.createElement(OpenlinkModal_1.OpenlinkModal, { url: 'https://www.zbay.app/', open: true, isImage: true, handleClose: jest.fn(), handleConfirm: jest.fn(), addToWhitelist: jest.fn(), setWhitelistAll: jest.fn() }));

...
describe('SidebarHeader', () => {
    it('renders component', () => {
        const result = (0, renderComponent_1.renderComponent)(react_1.default.createElement(SidebarHeader_1.SidebarHeader, { title: 'sample title', action: jest.fn(), actionTitle: jest.fn(), tooltipText: 'sample text' }));

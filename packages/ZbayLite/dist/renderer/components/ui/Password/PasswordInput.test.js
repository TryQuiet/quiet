...
describe('PasswordInput', () => {
    it('renders component', () => {
        const result = (0, renderComponent_1.renderComponent)(react_1.default.createElement(PasswordInput_1.PasswordInput, { label: 'Master password', password: 'test password', passwordVisible: false, handleTogglePassword: jest.fn(), handleSetPassword: jest.fn(), error: false }));
    ...
    it('renders with error', () => {
        const result = (0, renderComponent_1.renderComponent)(react_1.default.createElement(PasswordInput_1.PasswordInput, { label: '', password: '', passwordVisible: false, handleTogglePassword: jest.fn(), handleSetPassword: jest.fn(), error: true }));
        expect(result.baseElement).toMatchInlineSnapshot(`
      <body>
        <div>
          <div
    ...
    it('renders with password visible', () => {
        const result = (0, renderComponent_1.renderComponent)(react_1.default.createElement(PasswordInput_1.PasswordInput, { label: '', password: '', passwordVisible: true, handleTogglePassword: jest.fn(), handleSetPassword: jest.fn(), error: true }));
        expect(result.baseElement).toMatchInlineSnapshot(`
      <body>
        <div>
          <div

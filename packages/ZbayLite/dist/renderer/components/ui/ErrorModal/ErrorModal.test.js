...
describe('ErrorModal', () => {
    it('renders component', () => {
        const result = (0, renderComponent_1.renderComponent)(react_1.default.createElement(ErrorModal_1.ErrorModal, { open: true, message: 'Test error message', traceback: 'Error: Test error message, error traceback', handleExit: jest.fn(), restartApp: jest.fn() }));

...
describe('Slider', () => {
    it('renders component', () => {
        const result = (0, renderComponent_1.renderComponent)(react_1.default.createElement(Slider_1.Slider, { value: 23, handleOnChange: jest.fn(), title: 'this is a title of the slider', minLabel: '', maxLabel: '', min: 0, max: 0 }));
    ...
    it('renders with labels', () => {
        const result = (0, renderComponent_1.renderComponent)(react_1.default.createElement(Slider_1.Slider, { value: 23, handleOnChange: jest.fn(), title: 'this is a title of the slider', minLabel: '$ MIN', maxLabel: '$ MAX', min: 0, max: 0 }));
        expect(result.baseElement).toMatchInlineSnapshot(`
      <body>
        <div>
          <div
    ...
    it('renders custom min/max', () => {
        const result = (0, renderComponent_1.renderComponent)(react_1.default.createElement(Slider_1.Slider, { value: 8, handleOnChange: jest.fn(), title: 'this is a title of the slider', minLabel: '', maxLabel: '', min: -20, max: 20 }));
        expect(result.baseElement).toMatchInlineSnapshot(`
      <body>
        <div>
          <div

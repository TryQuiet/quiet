...
describe('UpdateModal', () => {
    it('renders component', () => {
        const result = (0, renderComponent_1.renderComponent)(react_1.default.createElement(UpdateModal_1.UpdateModal, { open: true, handleClose: jest.fn(), handleUpdate: jest.fn() }));

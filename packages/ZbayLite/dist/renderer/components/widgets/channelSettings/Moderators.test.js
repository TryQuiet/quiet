...
describe('Moderators', () => {
    it('renders component', () => {
        const users = {};
        const result = (0, renderComponent_1.renderComponent)(react_1.default.createElement(Moderators_1.Moderators, { users: users, moderators: [], openAddModerator: () => { }, removeModerator: () => { } }));

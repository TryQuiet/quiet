...
describe('Notifications', () => {
    it('renders component', () => {
        ...
        const result = (0, renderComponent_1.renderComponent)(react_1.default.createElement(Notifications_1.Notifications, { channelData: contact, openNotificationsTab: () => { }, setChannelsNotification: () => { }, openSettingsModal: () => { }, currentFilter: 1 }));

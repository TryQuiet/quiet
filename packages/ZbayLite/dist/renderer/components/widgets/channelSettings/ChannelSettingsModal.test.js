...
jest.mock('../../../containers/widgets/channelSettings/BlockedUsers', () => {
    const TabContent = () => react_1.default.createElement("div", null, "TabContent");
    return TabContent;
});
...
const ChannelSettingsModal_1 = require("./ChannelSettingsModal");
...
describe('ChannelSettingsModal', () => {
    it('renders component', () => {
        ...
        const result = (0, renderComponent_1.renderComponent)(react_1.default.createElement(react_redux_1.Provider, { store: store_1.default },
            react_1.default.createElement(ChannelSettingsModal_1.ChannelSettingsModal, { channel: contact, setCurrentTab: jest.fn(), handleClose: jest.fn(), currentTab: 'notifications', open: true, isOwner: false, modalTabToOpen: 'notifications', clearCurrentOpenTab: jest.fn() })));

...
describe('ConfirmModal', () => {
    it('renders component', () => {
        const result = (0, renderComponent_1.renderComponent)(react_1.default.createElement(ConfirmModal_1.ConfirmModal, { handleAction: () => { }, handleClose: () => { }, title: 'testtitle', actionName: 'testactionname', open: true, cancelName: '' }));

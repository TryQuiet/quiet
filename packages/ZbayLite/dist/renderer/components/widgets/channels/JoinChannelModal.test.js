...
const JoinChannelModal_1 = require("./JoinChannelModal");
const renderComponent_1 = require("../../../testUtils/renderComponent");
describe('JoinChannelModal', () => {
    it.skip('renders component', () => {
        const users = {};
        const result = (0, renderComponent_1.renderComponent)(react_1.default.createElement(JoinChannelModal_1.JoinChannelModal, { open: true, handleClose: () => { }, joinChannel: () => { }, publicChannels: [], users: users }));

...
const MentionPoper_1 = require("./MentionPoper");
describe('MentionPoper', () => {
    it('renders component highlight', () => {
        const anchor = document.createElement('div');
        const result = (0, renderComponent_1.renderComponent)(react_1.default.createElement(MentionPoper_1.MentionPoper, { anchorEl: anchor, selected: 1 },

...
describe('Security', () => {
    it('renders component', () => {
        const result = (0, renderComponent_1.renderComponent)(react_1.default.createElement(Security_1.Security, { openSeedModal: jest.fn(), allowAll: true, toggleAllowAll: jest.fn(), whitelisted: [], removeSiteHost: jest.fn() }));

...
describe('SettingsModal', () => {
    it('renders component', () => {
        const result = (0, renderComponent_1.renderComponent)(react_2.default.createElement(react_redux_1.Provider, { store: store_1.default },
            react_2.default.createElement(SettingsModal_1.SettingsModal, { user: 'string', owner: false, open: true, handleClose: jest.fn() })));
    ...
    it('displays "Add members" tab for community owner', () => __awaiter(void 0, void 0, void 0, function* () {
        (0, renderComponent_1.renderComponent)(react_2.default.createElement(SettingsModal_1.SettingsModal, { user: 'string', owner: true, open: true, handleClose: jest.fn() }));
        expect(react_1.screen.queryByRole('tab', { name: /Notifications/i })).not.toBeNull();
        expect(react_1.screen.queryByRole('tab', { name: /Add members/i })).not.toBeNull();
    }));
    it('does not display "Add members" tab if user is not a community owner', () => __awaiter(void 0, void 0, void 0, function* () {
        (0, renderComponent_1.renderComponent)(react_2.default.createElement(SettingsModal_1.SettingsModal, { user: 'string', owner: false, open: true, handleClose: jest.fn() }));
        expect(react_1.screen.queryByRole('tab', { name: /Notifications/i })).not.toBeNull();
        expect(react_1.screen.queryByRole('tab', { name: /Add members/i })).toBeNull();
    }));
});

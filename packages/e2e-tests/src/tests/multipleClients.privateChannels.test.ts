...
describe('Multiple Clients (Private Channels)', () => {
  ...
  describe('Stages:', () => {
    ...
    //     sidebarOwner = new Sidebar(users.owner.app.driver)
    //     await sidebarOwner.addNewChannel(privateChannelName)
    //     await sidebarOwner.switchChannel(privateChannelName)
    //     const channels = await sidebarOwner.getChannelList()
    //     expect(channels.length).toEqual(2)
    //   })
    ...
    //     await sidebarUser3.switchChannel(privateChannelName)
    ...
    //     sidebarUser3 = new Sidebar(users.user3.app.driver)
    //     await sidebarUser3.switchChannel(privateChannelName)
    //     secondChannelUser3 = new Channel(users.user3.app.driver, privateChannelName)
    ...
    //     expect(await generalChannelOwner.isOpen()).toBeTruthy()
    //     await generalChannelOwner.getMessageIdsByText(deleteChannelMessage(privateChannelName), users.owner.username)
    //   })

    //   it('User sees info about channel deletion in general channel', async () => {
    //     expect(await generalChannelUser1.isOpen()).toBeTruthy()
    //     await generalChannelUser1.getMessageIdsByText(deleteChannelMessage(privateChannelName), users.owner.username)
    //   })
    ...
    //     await generalChannelUser3.getMessageIdsByText(deleteChannelMessage(privateChannelName), users.owner.username)
    //   })
    ...
    //     await sidebarUser1.addNewChannel(privateChannelName)
    //     await sidebarUser1.switchChannel(privateChannelName)
    //     const messages = await privateChannelUser1.getUserMessages(users.user1.username)
    //     expect(messages.length).toEqual(1)
    //     expect(await privateChannelUser1.isReady()).toBeTruthy()
    //     const channels = await sidebarUser1.getChannelList()
    //     expect(channels.length).toEqual(2)
    //   })

    //   it('Owner sees the recreated second channel', async () => {
    //     expect(await privateChannelOwner.isReady(30_000)).toBeTruthy()
    //     const channels = await sidebarOwner.getChannelList()
    //     expect(channels.length).toEqual(2)
    //   })

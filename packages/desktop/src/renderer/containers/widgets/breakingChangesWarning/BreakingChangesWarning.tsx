...
const BreakingChangesWarning = () => {
  ...
  const message =
    'Quiet 7.0 includes improvements that are not backwards compatible, so you must re-install Quiet from tryquiet.org and re-create or re-join your community. This version of Quiet (6.x) will no longer receive any updates or security fixes, so please re-install soon. We apologize for the inconvenience.'

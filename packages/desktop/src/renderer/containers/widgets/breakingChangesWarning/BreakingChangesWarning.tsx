...
const BreakingChangesWarning = () => {
  ...
  const message =
    'Quiet 11.0 adds device linking, so you can use one account on several devices! 🎉 However, it is not backwards compatible, so you must re-install Quiet from tryquiet.org and re-create or re-join your community: your existing communities and identities will not carry over. 😥 This version of Quiet (9.x) will no longer receive any updates or security fixes, so please re-install soon. We apologize for the inconvenience.'

...
const SettingsModalContainer = () => {
  ...
  const leaveCommunityModal = useModal(ModalName.leaveCommunityModal)

  return <SettingsModal title={'Settings'} isOwner={isOwner} {...modal} leaveCommunityModal={leaveCommunityModal} />
}

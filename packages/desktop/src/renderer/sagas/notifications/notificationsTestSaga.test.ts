...
describe('displayMessageNotificationSaga', () => {
  ...
  function mainPath() {
    return testSaga(displayMessageNotificationSaga, {
      payload: incomingMessages,
      type: 'PublicChannels/incomingMessages'
    })
      .next()

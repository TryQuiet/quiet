...
export const AgreeAndJoinServerOptIn_3054_4090 = () => (
  <Stage flow={flow} frame={frame('agree-and-join-server-opt-in-3054-4090')} />
)
...
export const AgreeAndJoinV_1BeforeWeSupportMultipleHosts = () => (

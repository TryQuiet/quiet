...
describe('NestedMessageContent', () => {
      ...
      expect(result.baseElement).toMatchInlineSnapshot(`
        <body>
          <div>
            ...
            >
              <span
                class="MuiTypography-root MuiTypography-body1 TextMessagemessage TextMessagepending css-105mmrw-MuiTypography-root"
                data-testid="messagesGroupContent-0"
              >
                message0
              </span>
  ...
  describe('Unsent Messages', () => {
    it('renders unsent message', () => {
      const messages = generateMessages()
      const result = renderComponent(
        <NestedMessageContent pending={false} isUnsent={true} message={messages[0]} openUrl={jest.fn()} />
      )
      expect(result.baseElement).toMatchInlineSnapshot(`
        <body>
          <div>
    ...
    it('renders pending unsent message', () => {
      const messages = generateMessages()
      const result = renderComponent(
        <NestedMessageContent pending={true} isUnsent={true} message={messages[0]} openUrl={jest.fn()} />
      )
      expect(result.baseElement).toMatchInlineSnapshot(`
        <body>
          <div>
            ...
            >
              <span
                class="MuiTypography-root MuiTypography-body1 TextMessagemessage TextMessagepending TextMessageunsent css-105mmrw-MuiTypography-root"
                data-testid="messagesGroupContent-0"
              >
                message0
              </span>
    ...
    it('renders proper download status for malicious unsent file', async () => {
      // TODO: add tests for the rest of statuses
      const messages = generateMessages({ type: 2 })
    ...
    it('renders file as unsent', () => {
      ...
      const result = renderComponent(
        <NestedMessageContent pending={false} isUnsent={true} message={message} openUrl={jest.fn()} />
      )
      expect(result.baseElement).toMatchInlineSnapshot(`
        <body>
          <div>
            ...
            >
              <div
                class="NestedMessageContentmessage NestedMessageContentunsent"
                data-testid="messagesGroupContent-0"
              >
                <div
                  class="css-1clc91l"
                >
                  <div
                    class="UploadedImagecontainer UploadedImageunsent"
                  >
                    <div
                      class="UploadedImageimage"
                      data-testid="abcd1234-imageVisual"
    ...
    it('renders unsent large image as file', () => {
      const messages = generateMessages({ type: 2 })

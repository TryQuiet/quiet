            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <button
                      class="MuiButtonBase-root MuiButtonBase-root makeStyles-root-157"
                      tabindex="0"
                      type="button"
                    >
                      <span
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <button
                                aria-label="Clear"
                                class="MuiButtonBase-root MuiButtonBase-root MuiAutocomplete-clearIndicator MuiAutocomplete-clearIndicatorDirty"
                                tabindex="-1"
                                title="Clear"
                                type="button"
                              >
                              ...
                              <button
                                aria-label="Open"
                                class="MuiButtonBase-root MuiButtonBase-root MuiAutocomplete-popupIndicator"
                                tabindex="-1"
                                title="Open"
                                type="button"
                              >

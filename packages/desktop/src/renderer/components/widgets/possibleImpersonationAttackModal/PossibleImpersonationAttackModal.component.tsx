        ...
        <Modal open={open} handleClose={handleClose} title={'Warning!'} isBold addBorder>
            ...
            >
                ...
                <Typography className={classes.bodyText} variant='body2'>
                    The owner of <strong>{communityName}</strong> has registered an invalid username. Either something
                    is very broken, the community owner is trying to impersonate other users, or the community owner has
                    been hacked.
                    <br />

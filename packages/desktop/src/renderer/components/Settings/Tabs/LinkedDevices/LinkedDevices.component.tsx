...
const classes = {
  button: 'LinkedDevicesbutton',
  code: 'LinkedDevicescode',
  description: 'LinkedDevicesdescription',
  link: 'LinkedDeviceslink',
  linkContainer: 'LinkedDeviceslinkContainer',
  linkVisibility: 'LinkedDeviceslinkVisibility',
  title: 'LinkedDevicestitle',
}
const StyledGrid = styled(Grid)(({ theme }) => ({
  [`& .${classes.title}`]: { marginBottom: 24 },
  [`& .${classes.description}`]: { marginTop: 8 },
  [`& .${classes.code}`]: { alignSelf: 'center', marginTop: 24 },
  ...
  [`& .${classes.linkVisibility}`]: { margin: 5, position: 'absolute', right: 0, top: 8 },
  [`& .${classes.button}`]: {
    ...
    textTransform: 'none',
    width: '100%',
    '&:hover': { backgroundColor: theme.palette.colors.quietBlue, opacity: 0.7 },
  },
}))

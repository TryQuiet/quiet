 ...
 * Inside a community this device shares: Display QR code opens the QR code one level down in
 * this panel (#3690), the way QR Code shows the invite; Copy link copies the same link and
 * confirms with the design's toast.
 *
 ...
 */
export const LinkedDevices: FC<{ openTab?: (tab: string) => void }> = ({ openTab }) => {
  ...
  return (
    <>
      <LinkDevicesComponent
        ...
        onDisplayQrCode={() => openTab?.('linkedDevicesQr')}

...
const logger = createLogger('JoiningOptIn:component')

const PREFIX = 'JoiningOptInComponent-'
const classes = {
    ...
    <Modal open={open} handleClose={handleClose} isCloseDisabled={true} testIdPrefix='JoiningOptIn'>
      <StyledGrid container direction='column' alignItems='center' className={classes.contentWrap}>
        ...
        <StyledGrid container direction='column' alignItems='center' className={classes.textWrap}>
          <Grid item>
            <Typography variant='h3'>This community is hosted on Quiet’s server</Typography>
          </Grid>
          <Grid item>
        ...
        <StyledGrid container direction='column' alignItems='center' className={classes.actionsWrap}>
          <Grid item>
            <Button
              ...
              data-testid='JoiningOptIn-UseQuietServer'
              size='large'
            >
              Use Quiet’s server
            </Button>
          ...
          <Grid item>
            <Button
              ...
              data-testid='JoiningOptIn-Abort'
              size='small'
            >
              Leave Community
            </Button>

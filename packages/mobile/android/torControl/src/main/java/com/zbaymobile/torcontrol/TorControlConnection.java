...
package com.zbaymobile.torcontrol;
...
public class TorControlConnection implements com.zbaymobile.torcontrol.TorControlCommands {
    ...
    private volatile com.zbaymobile.torcontrol.EventHandler handler;
    ...
    protected void handleEvent(ArrayList<ReplyLine> events) {
        ...
        for (Iterator<ReplyLine> i = events.iterator(); i.hasNext(); ) {
            ...
            if (tp.equals("CIRC")) {
                List<String> lst = com.zbaymobile.torcontrol.Bytes.splitStr(null, rest);
    ...
    */
    ...
    public void setEventHandler(com.zbaymobile.torcontrol.EventHandler handler) {
    ...
    public List<com.zbaymobile.torcontrol.ConfigEntry> getConf(String key) throws IOException {
        List<String> lst = new ArrayList<String>();
        lst.add(key);
        return getConf(lst);
    }
     ...
     */
    public List<com.zbaymobile.torcontrol.ConfigEntry> getConf(Collection<String> keys) throws IOException {
        ...
        List<com.zbaymobile.torcontrol.ConfigEntry> result = new ArrayList<com.zbaymobile.torcontrol.ConfigEntry>();
        for (Iterator<ReplyLine> it = lst.iterator(); it.hasNext(); ) {
            String kv = (it.next()).msg;
            int idx = kv.indexOf('=');
            if (idx >= 0)
                result.add(new com.zbaymobile.torcontrol.ConfigEntry(kv.substring(0, idx),
                                           kv.substring(idx+1)));
            else
                result.add(new com.zbaymobile.torcontrol.ConfigEntry(kv));
        }
        return result;
    }
    ...
    public void authenticate(byte[] auth) throws IOException {
        String cmd = "AUTHENTICATE " + com.zbaymobile.torcontrol.Bytes.hex(auth) + "\r\n";

...
## [9.0.1](https://github.com/TryQuiet/quiet/compare/@quiet/mobile@9.0.0-alpha.7...@quiet/mobile@9.0.1) (2026-09-10)


### Bug Fixes

* authenticate native notification messages [#114](https://github.com/TryQuiet/quiet/issues/114) ([3dd2758](https://github.com/TryQuiet/quiet/commit/3dd27583a8a47aa0c608075cd4f3ca120caf7182))
* classify malformed notification generations permanently ([f484ddf](https://github.com/TryQuiet/quiet/commit/f484ddffa668267537e67b4df3bc6463228e935a))
* complete native notification authentication [#114](https://github.com/TryQuiet/quiet/issues/114) ([9b45884](https://github.com/TryQuiet/quiet/commit/9b458843081d5cf0d3eebb8c31fc88e26fd0c77c))
* improve UserMetadataHandler initialization by ensuring directory creation for persistent store ([ad84b61](https://github.com/TryQuiet/quiet/commit/ad84b6197ed5051c16cb56e9c53508854780df92))
* **ios:** check the JSON token type for NSE challenge timestamps instead of Decimal ([#342](https://github.com/TryQuiet/quiet/issues/342)) ([cac29a6](https://github.com/TryQuiet/quiet/commit/cac29a6976028ff4ee350da0e48e8f62e61e17aa))
* **ios:** drop the NSE log fetch size cap; keep the auth endpoint caps ([#342](https://github.com/TryQuiet/quiet/issues/342)) ([e40e17f](https://github.com/TryQuiet/quiet/commit/e40e17f1888b1c826152500b7127cb5384f99a56))
* **ios:** reject fractional timestamp literals in NSE challenges; fix test server body read ([#342](https://github.com/TryQuiet/quiet/issues/342)) ([c8d407f](https://github.com/TryQuiet/quiet/commit/c8d407fb8e0296bff594c29d44bccc1a8de4a14d))
* **ios:** scan NSE challenge JSON strictly; reject duplicate members and bound responses ([#342](https://github.com/TryQuiet/quiet/issues/342)) ([d3b322f](https://github.com/TryQuiet/quiet/commit/d3b322f68a83ce4badfeba27bc754373642d938f))
* **mobile:** bound missing notification key retries ([#114](https://github.com/TryQuiet/quiet/issues/114)) ([9bb41f6](https://github.com/TryQuiet/quiet/commit/9bb41f6bcbe1898e0400043acdcab24aab334fa3))
* **mobile:** disable Android native heap pointer tagging to stop JSC crash ([95ce188](https://github.com/TryQuiet/quiet/commit/95ce188bba3baa48966be7d286569b9634295804)), closes [#325](https://github.com/TryQuiet/quiet/issues/325)
* **mobile:** point dev QSS_ENDPOINT at localhost instead of a LAN IP ([b04bbbe](https://github.com/TryQuiet/quiet/commit/b04bbbef0c6b070aae99257b2eaf10cc1bd802a9)), closes [#318](https://github.com/TryQuiet/quiet/issues/318)
* **mobile:** reconcile Android background lifecycle and socket recovery ([c6cd5d1](https://github.com/TryQuiet/quiet/commit/c6cd5d189effb78fd604a06a7c02d6b17da1a63d))
* **mobile:** suppress self and unknown-user notifications on Android and iOS ([#339](https://github.com/TryQuiet/quiet/issues/339)) ([e98e974](https://github.com/TryQuiet/quiet/commit/e98e974712e6d939d13908553be60f453cf2af2a))
* **mobile:** update Android libtor.so to Tor 0.4.9.11 and re-enable Android in update script ([9bc4027](https://github.com/TryQuiet/quiet/commit/9bc40275b33639a54c65a14049ff0a135f3ebf79))
* **push:** store native push prerequisites after a fresh join; stop duplicate websocket start from cancelling the join ([#346](https://github.com/TryQuiet/quiet/issues/346), [#347](https://github.com/TryQuiet/quiet/issues/347)) ([#348](https://github.com/TryQuiet/quiet/issues/348)) ([2abea2f](https://github.com/TryQuiet/quiet/commit/2abea2ffce87cd94c8653fa58a50eb6e602bbe51))
* reject malformed notifications before key retry ([6a22aa4](https://github.com/TryQuiet/quiet/commit/6a22aa45e41e287d74b4f888c1dcb38a34958b41))
* **security:** bind native NSE auth to QSS identity [#115](https://github.com/TryQuiet/quiet/issues/115) ([cc0a6d7](https://github.com/TryQuiet/quiet/commit/cc0a6d7d1e2e9e78f883d7b5b5cffdc0e9adc5ad))
* **security:** close NSE proof validation gaps [#115](https://github.com/TryQuiet/quiet/issues/115) ([5e29b4c](https://github.com/TryQuiet/quiet/commit/5e29b4c08744270faf3884ff1fc7e9fcd6a866a5))
* **security:** harden QPS notification envelopes [#135](https://github.com/TryQuiet/quiet/issues/135) ([5a51027](https://github.com/TryQuiet/quiet/commit/5a5102714eac32e677859d8fb0176896000a8fa9))
* validate notification scopes before key lookup ([04bdb7d](https://github.com/TryQuiet/quiet/commit/04bdb7d26afb41af3d970b5ecd8f62cd548ad975))
* validate NSE message shape after decoding [#114](https://github.com/TryQuiet/quiet/issues/114) ([3798775](https://github.com/TryQuiet/quiet/commit/37987753d50b0253815660ba6290156eb6dedcf8))
...
* enhance backend lifecycle management and websocket connection handling ([0d0c4d9](https://github.com/TryQuiet/quiet/commit/0d0c4d911bbfdd6632f6eadd03b3b89430755052))
* Implement QuietBackgroundTask for managing background transitions ([1685502](https://github.com/TryQuiet/quiet/commit/16855026a261966d4eee3491d662d3bfecceab59))
...
* Suppress per-message notifications on Android and iOS for users with unknown usernames, and for one's own messages [#337](https://github.com/TryQuiet/quiet-private/issues/337)

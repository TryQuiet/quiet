...
- There are no manifest orientation or resizability restrictions to opt out of.
  Check actual rotation and window resizing before changing layouts.
...
onboarding and messaging, channel/modal Back, media attachments, chat/drawer
layouts, background recovery, and the iOS smoke checks remain unverified.

...
import { replaceScreenSaga, resetToScreenSaga, resetToStackSaga } from './replaceScreen/replaceScreen.saga'
...
export function* navigationMasterSaga(): Generator {
  yield all([
    ...
    takeEvery(navigationActions.resetToScreen.type, resetToScreenSaga),
    takeEvery(navigationActions.resetToStack.type, resetToStackSaga),

        ...
        >
            ...
            >
                ...
                <Typography
                    fontSize={14}
                    fontWeight={'medium'}
                    style={{ lineHeight: 20, textAlign: 'center', marginTop: 40 }}
                >
                ...
                <Typography fontSize={14} style={{ lineHeight: 20, textAlign: 'center', marginTop: 25 }}>
                    Quiet stores data on your community’s devices (not Big Tech’s servers!) using the battle-tested
                    privacy tool Tor to protect your information. Tor is fast once connected, but it can be slow at
                    first, and leaving this screen
                    {Platform.OS === 'ios'
                        ? ' will stop the process of joining.'
                        : ' could stop the process of joining.'}
                </Typography>

                <TouchableWithoutFeedback onPress={() => openUrl(Site.MAIN_PAGE)} testID={'learn-more-link'}>
                    <Typography
                        fontSize={14}
                        style={{ lineHeight: 20, textAlign: 'center', marginTop: 40, color: '#2373EA' }}
                    >

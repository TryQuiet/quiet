...
storiesOf('Input', module)
  ...
  .add('Label', () => (
    <Input label={'Choose your favorite username'} placeholder={'Enter a username'} validation={undefined} />
  ))
  .add('Validation', () => (
    <Input label={'Choose your favorite username'} placeholder={'Enter a username'} validation={'Username invalid'} />
  ))
  .add('Hint', () => (
    <Input

    ...
    >
      ...
      <View style={classes.mainWrapper}>
        ...
        <Typography fontSize={14} style={classes.text1}>
          ...
          has registered an invalid username. Either something is very broken, the community owner is trying to
          impersonate other users, or the community owner has been hacked.
        </Typography>

...
const identity_2 = require("@zbayapp/identity");
...
describe("registrar", () => {
    ...
    test("launch communities and registrars on startup", async () => {
        ...
        const userCsr = await (0, identity_1.createUserCsr)({
            ...
            signAlg: identity_2.configCrypto.signAlg,
            hashAlg: identity_2.configCrypto.hashAlg,
        });
        userCsr.userKey =
        ...
        const app = await (0, utils_1.createApp)({
            [nectar_1.StoreKeys.Communities]: Object.assign(Object.assign({}, new nectar_4.communities.state()), { currentCommunity: "F1141EBCF93387E5A28696C5B41E2177", communities: Object.assign({}, nectar_3.communitiesAdapter.setAll(nectar_3.communitiesAdapter.getInitialState(), [
                    community,
                ])) }),
            [nectar_1.StoreKeys.Identity]: Object.assign(Object.assign({}, new nectar_5.identity.state()), { identities: Object.assign({}, nectar_2.identityAdapter.setAll(nectar_2.identityAdapter.getInitialState(), [
                    user,
                ])) }),
            [nectar_1.StoreKeys.PublicChannels]: Object.assign(Object.assign({}, new nectar_6.publicChannels.state()), { channels: nectar_7.communityChannelsAdapter.setAll(nectar_7.communityChannelsAdapter.getInitialState(), [communityChannels]) }),
        });

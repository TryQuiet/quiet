...
describe('checkForMessagesSaga', () => {
  ...
  test('ask for missing messages', async () => {
    ...
    await expectSaga(checkForMessagesSaga, messagesActions.responseSendMessagesIds({ids: ['jf84hwwa'], channelAddress: channel.address, communityId: community.id}))
      .withReducer(reducer)

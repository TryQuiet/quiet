...
- Rebuild the full Quiet app with the new Xcode phase and run its normal messaging
  tests. The script and binary were tested directly; a full RN app build has not

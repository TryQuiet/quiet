    ...
    store = createStore(
      ...
      }),
      {
        [StoreKeys.Communities]: {
          ...
          communities: communitiesAdapter.setAll(communitiesAdapter.getInitialState(), [quietcommunity]),
        },
        [StoreKeys.Users]: {
          ...new UsersState(),
          certificates: certificatesAdapter.setAll(certificatesAdapter.getInitialState(), [parsedCert]),
        },
      }
    )
  })

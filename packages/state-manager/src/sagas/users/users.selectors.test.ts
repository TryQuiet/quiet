...
describe('users selectors', () => {
    ...
    beforeAll(async () => {
        ...
        aliceUnregistered = await factory.create<ReturnType<typeof identityActions.addNewIdentity>['payload']>(
            'Identity',
            {
                id: community.id,
                nickname: aliceCertificateData.username,
        ...
        const parsedAliceUnregisteredCertificationRequest = parseCertificationRequest(
            aliceUnregistered.userCsr!.userCsr
        )

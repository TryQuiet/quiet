...
import { type Community, ErrorCodes, ErrorMessages, ErrorTypes, type Identity } from '@quiet/types'
...
describe('handle errors', () => {
  ...
  test('receiving registrar server error results in retrying registration', async () => {
    ...
    await expectSaga(handleErrorsSaga, errorsActions.handleError(errorPayload))
      .withReducer(reducer)
